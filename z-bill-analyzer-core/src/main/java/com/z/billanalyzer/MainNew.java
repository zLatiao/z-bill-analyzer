...
public class MainNew {
    public static void main(String[] args) throws IOException {
        ...
        WxBillExcelParser wxBillParser = new WxBillExcelParser();
        ...
        AlipayBillExcelParser alipayBillParser = new AlipayBillExcelParser();
        ...
        CmbBillExcelParser cmbBillParser = new CmbBillExcelParser();
