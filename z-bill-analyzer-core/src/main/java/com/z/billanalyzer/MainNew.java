...
public class MainNew {
    public static void main(String[] args) throws IOException {
        ArrayList<BaseBill> list = new ArrayList<>();
        ...
        CmbBill cmbBillInfo = cmbBillParser.parse(new File("C:\\Users\\Administrator\\Desktop\\账单\\CMB_6214--------9016_20240101_20250331.csv"));
